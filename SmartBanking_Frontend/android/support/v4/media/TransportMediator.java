...
public class TransportMediator extends TransportController {
    ...
    class C00282 implements Callback {
        C00282() {
        }
    ...
    class C01731 implements TransportMediatorCallback {
        C01731() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C01731();
        this.mKeyEventCallback = new C00282();
