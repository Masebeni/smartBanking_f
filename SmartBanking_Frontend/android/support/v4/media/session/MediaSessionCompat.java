...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        ...
        static class C00361 implements Creator<QueueItem> {
            C00361() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        ...
        static class C00371 implements Creator<ResultReceiverWrapper> {
            C00371() {
            }
    ...
    public static final class Token implements Parcelable {
        ...
        static class C00381 implements Creator<Token> {
            C00381() {
            }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
            ...
            private void onMediaButtonEvent(KeyEvent ke) {
                ...
                if (ke != null && ke.getAction() == 0) {
                    ...
                    switch (ke.getKeyCode()) {
                        case C0160R.styleable.Theme_panelMenuListTheme /*79*/:
                        case C0160R.styleable.Theme_colorControlActivated /*85*/:
                            boolean isPlaying;
                        ...
                        case C0160R.styleable.Theme_colorControlHighlight /*86*/:
                            if ((1 & validActions) != 0) {
                                MediaSessionImplBase.this.mCallback.onStop();
                            }
                        case C0160R.styleable.Theme_colorButtonNormal /*87*/:
                            if ((32 & validActions) != 0) {
                                MediaSessionImplBase.this.mCallback.onSkipToNext();
                            }
                        case C0160R.styleable.Theme_colorSwitchThumbNormal /*88*/:
                            if ((16 & validActions) != 0) {
                                MediaSessionImplBase.this.mCallback.onSkipToPrevious();
                            }
                        case C0160R.styleable.Theme_controlBackground /*89*/:
                            if ((8 & validActions) != 0) {
                                MediaSessionImplBase.this.mCallback.onRewind();
                            }
                        case C0160R.styleable.Theme_alertDialogStyle /*90*/:
        ...
        class C01751 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C01751() {
            }
        ...
        class C01762 implements android.support.v4.media.session.MediaSessionCompatApi14.Callback {
            final /* synthetic */ Callback val$callback;

            C01762(Callback callback) {
        ...
        public MediaSessionImplBase(Context context, String tag, ComponentName mbrComponent, PendingIntent mbr) {
            ...
            this.mVolumeCallback = new C01751();
        ...
        public void setCallback(Callback callback, Handler handler) {
            if (callback != this.mCallback) {
                if (callback == null || VERSION.SDK_INT < 18) {
                    ...
                    android.support.v4.media.session.MediaSessionCompatApi14.Callback cb14 = new C01762(callback);
                    if (VERSION.SDK_INT >= 18) {
