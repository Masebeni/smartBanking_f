...
public class ViewPager extends ViewGroup {
    ...
    static class C00611 implements Comparator<ItemInfo> {
        C00611() {
        }
    ...
    static class C00622 implements Interpolator {
        C00622() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C01831 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01831() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C01831());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00611();
        sInterpolator = new C00622();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00633();
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            case C0160R.styleable.Toolbar_navigationContentDescription /*21*/:
                return arrowScroll(17);
            case C0160R.styleable.Toolbar_logoDescription /*22*/:
