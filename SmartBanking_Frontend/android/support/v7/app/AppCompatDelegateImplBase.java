...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    class AppCompatWindowCallbackBase extends WindowCallbackWrapper {
        ...
        public boolean onMenuOpened(int featureId, Menu menu) {
            return super.onMenuOpened(featureId, menu) || AppCompatDelegateImplBase.this.onMenuOpened(featureId, menu);
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (a.hasValue(C0111R.styleable.Theme_windowActionBar)) {
            if (a.getBoolean(C0111R.styleable.Theme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (a.getBoolean(C0111R.styleable.Theme_windowActionBar, false)) {
