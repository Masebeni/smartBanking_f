...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01061 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV7.this.mInvalidatePanelMenuFeatures & AccessibilityNodeInfoCompat.ACTION_SCROLL_FORWARD) != 0) {
                AppCompatDelegateImplV7.this.doInvalidatePanelMenu(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR);
            }
    ...
    class C01074 implements Runnable {
        ...
        class C02451 extends ViewPropertyAnimatorListenerAdapter {
            C02451() {
            }
        ...
        public void run() {
            ...
            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C02451());
        }
    }
    ...
    class C01892 implements OnApplyWindowInsetsListener {
        C01892() {
        }
    ...
    class C01903 implements OnFitSystemWindowsListener {
        C01903() {
        }
    ...
    class ActionModeCallbackWrapperV7 implements ActionMode.Callback {
        ...
        class C02471 extends ViewPropertyAnimatorListenerAdapter {
            C02471() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV7.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C02471());
            }
    ...
    class C02465 extends ViewPropertyAnimatorListenerAdapter {
        C02465() {
        }
    ...
    AppCompatDelegateImplV7(Context context, Window window, AppCompatCallback callback) {
        ...
        this.mFadeAnim = null;
        this.mInvalidatePanelMenuRunnable = new C01061();
    }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(this.mSubDecor, new C01892());
                } else {
                    ((FitWindowsViewGroup) this.mSubDecor).setOnFitSystemWindowsListener(new C01903());
                }
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mShowActionModePopup = new C01074();
                } else {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    this.mFadeAnim.setListener(new C02465());
                    if (this.mActionModePopup != null) {
    ...
    boolean onKeyUp(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case TransportMediator.FLAG_KEY_MEDIA_PLAY /*4*/:
                ...
                break;
            case C0160R.styleable.Theme_colorPrimaryDark /*82*/:
    ...
    boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (VERSION.SDK_INT >= 11 || !onKeyShortcut(keyCode, event)) {
            return false;
        }
        return true;
    }
