...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C01923 implements ViewPropertyAnimatorUpdateListener {
        C01923() {
        }
    ...
    class C02492 extends ViewPropertyAnimatorListenerAdapter {
        C02492() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C02481();
        this.mShowListener = new C02492();
        this.mUpdateListener = new C01923();
    ...
    private void init(View decor) {
        ...
        if (a.getBoolean(C0111R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
