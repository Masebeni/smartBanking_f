...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C02511 extends ViewPropertyAnimatorListenerAdapter {
        C02511() {
        }
    ...
    static {
        ATTRS = new int[]{C0111R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mRemoveActionBarHideOffset = new C01152();
        this.mAddActionBarHideOffset = new C01163();
        init(context);
