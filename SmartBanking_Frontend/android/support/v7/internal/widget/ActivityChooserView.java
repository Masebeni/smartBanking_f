...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C01181 extends DataSetObserver {
        C01181() {
        }
    ...
    class C01192 implements OnGlobalLayoutListener {
        C01192() {
        }
    ...
    class C01204 extends DataSetObserver {
        C01204() {
        }
    ...
    class C01943 extends ForwardingListener {
        C01943(View x0) {
            super(x0);
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetOberver = new C01181();
        this.mOnGlobalLayoutListener = new C01192();
        ...
        expandButton.setOnTouchListener(new C01943(expandButton));
        ...
        this.mAdapter.registerDataSetObserver(new C01204());
