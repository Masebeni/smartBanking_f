...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    class C02522 extends ViewPropertyAnimatorListenerAdapter {
    ...
    class C02533 extends ViewPropertyAnimatorListenerAdapter {
        C02533() {
        }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription, int defaultNavigationIcon) {
        ...
        this.mToolbar.setNavigationOnClickListener(new C01231());
    }
    ...
    private void ensureSpinner() {
        if (this.mSpinner == null) {
            this.mSpinner = new AppCompatSpinner(getContext(), null, C0111R.attr.actionDropDownStyle);
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int visibility, long duration) {
        ...
        if (visibility == 8) {
            anim = ViewCompat.animate(this.mToolbar).alpha(0.0f);
            anim.setDuration(duration);
            anim.setListener(new C02522());
            return anim;
        } else if (visibility != 0) {
            return null;
        } else {
            anim = ViewCompat.animate(this.mToolbar).alpha(1.0f);
            anim.setDuration(duration);
            anim.setListener(new C02533());
            return anim;
        }
    }
