...
public class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private static class SavedState implements Parcelable {
        ...
        static class C01251 implements Creator<SavedState> {
            C01251() {
            }
    ...
    private class OverflowMenuButton extends TintImageView implements ActionMenuChildView {
        ...
        class C01951 extends ForwardingListener {
            final /* synthetic */ ActionMenuPresenter val$this$0;

            C01951(View x0, ActionMenuPresenter actionMenuPresenter) {
        ...
        public OverflowMenuButton(Context context) {
            ...
            setVisibility(0);
            setEnabled(true);
            setOnTouchListener(new C01951(this, ActionMenuPresenter.this));
        }
