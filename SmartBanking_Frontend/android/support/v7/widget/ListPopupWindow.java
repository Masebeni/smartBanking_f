...
public class ListPopupWindow {
    ...
    class C01313 implements OnItemSelectedListener {
        C01313() {
        }
    ...
    class C01971 extends ForwardingListener {
        C01971(View x0) {
            super(x0);
        }
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0111R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0111R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
        ...
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode))) {
            ...
            if (!(below && keyCode == 19 && curIndex <= firstItem) && (below || keyCode != 20 || curIndex < lastItem)) {
                ...
                if (this.mDropDownList.onKeyDown(keyCode, event)) {
                    ...
                    show();
                    switch (keyCode) {
                        case C0160R.styleable.Toolbar_collapseContentDescription /*19*/:
                        case HttpConnectionManagerParams.DEFAULT_MAX_TOTAL_CONNECTIONS /*20*/:
                        case C0160R.styleable.Toolbar_titleTextColor /*23*/:
                        case C0160R.styleable.Theme_textColorSearchUrl /*66*/:
                            return true;
                    }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C01302();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C01313());
