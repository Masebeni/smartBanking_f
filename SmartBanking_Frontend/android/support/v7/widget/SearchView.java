...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01354 implements OnFocusChangeListener {
        C01354() {
        }
    ...
    class C01365 implements OnLayoutChangeListener {
        C01365() {
        }
    ...
    class C01376 implements OnGlobalLayoutListener {
        C01376() {
        }
    ...
    class C01387 implements OnClickListener {
        C01387() {
        }
    ...
    class C01398 implements OnKeyListener {
        C01398() {
        }
    ...
    class C01409 implements OnEditorActionListener {
        C01409() {
        }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C01321();
        this.mUpdateDrawableStateRunnable = new C01332();
        this.mReleaseCursorRunnable = new C01343();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01387();
        this.mTextKeyListener = new C01398();
        this.mOnEditorActionListener = new C01409();
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01354());
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01365());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01376());
    }
