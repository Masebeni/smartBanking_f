...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    class C02301 extends BoundField {
        ...
        C02301(String name, boolean serialized, boolean deserialized, Field field, boolean z, TypeAdapter typeAdapter, Gson gson, TypeToken typeToken, boolean z2) {
        ...
        void write(JsonWriter writer, Object value) throws IOException, IllegalAccessException {
            ...
            if (this.val$jsonAdapterPresent) {
                t = this.val$typeAdapter;
            } else {
                t = new TypeAdapterRuntimeTypeWrapper(this.val$context, this.val$typeAdapter, this.val$fieldType.getType());
            }
    ...
    private BoundField createBoundField(Gson context, Field field, String name, TypeToken<?> fieldType, boolean serialize, boolean deserialize) {
        ...
        return new C02301(name, serialize, deserialize, field, jsonAdapterPresent, mapped, context, fieldType, isPrimitive);
    }
