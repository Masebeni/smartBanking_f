...
public class JsonReader implements Closeable {
    ...
    static class C02441 extends JsonReaderInternalAccess {
        C02441() {
        }
    ...
    static {
        NON_EXECUTE_PREFIX = ")]}'\n".toCharArray();
        JsonReaderInternalAccess.INSTANCE = new C02441();
    }
    ...
    int doPeek() throws IOException {
        ...
        if (peekStack == PEEKED_BEGIN_OBJECT) {
            ...
            switch (nextNonWhitespace(true)) {
                case C0160R.styleable.Theme_listDividerAlertDialog /*44*/:
                    break;
                case C0160R.styleable.Theme_toolbarNavigationButtonStyle /*59*/:
                    checkLenient();
                    break;
                case C0160R.styleable.Theme_alertDialogTheme /*93*/:
            ...
            switch (c) {
                case C0160R.styleable.Theme_actionModePasteDrawable /*34*/:
                    this.peeked = PEEKED_DOUBLE_QUOTED_NAME;
                    return PEEKED_DOUBLE_QUOTED_NAME;
                case C0160R.styleable.Theme_actionModePopupWindowStyle /*39*/:
                    checkLenient();
            ...
            switch (nextNonWhitespace(true)) {
                case C0160R.styleable.Theme_toolbarStyle /*58*/:
                    break;
                case C0160R.styleable.Theme_popupWindowStyle /*61*/:
                    checkLenient();
        ...
        switch (nextNonWhitespace(true)) {
            ...
            case C0160R.styleable.Theme_toolbarNavigationButtonStyle /*59*/:
                break;
            case C0160R.styleable.Theme_alertDialogButtonGroupStyle /*91*/:
    ...
    private int peekNumber() throws IOException {
        ...
        while (true) {
            ...
            char c = buffer[p + i];
            switch (c) {
                case C0160R.styleable.Theme_dialogPreferredPadding /*43*/:
                    if (last != PEEKED_TRUE) {
                        return PEEKED_NONE;
                    }
                    last = PEEKED_FALSE;
                    continue;
                case C0160R.styleable.Theme_actionDropDownStyle /*45*/:
                    if (last == 0) {
                        negative = true;
                ...
                case C0160R.styleable.Theme_dropdownListPreferredItemHeight /*46*/:
                    if (last != PEEKED_END_OBJECT) {
                        return PEEKED_NONE;
                    }
                    last = PEEKED_BEGIN_ARRAY;
                    continue;
                case C0160R.styleable.Theme_listPreferredItemHeightSmall /*69*/:
    ...
    private boolean isLiteral(char c) throws IOException {
        switch (c) {
            ...
            case '}':
                break;
            case C0160R.styleable.Theme_actionModeSelectAllDrawable /*35*/:
            case C0160R.styleable.Theme_spinnerDropDownItemStyle /*47*/:
            case C0160R.styleable.Theme_toolbarNavigationButtonStyle /*59*/:
            case C0160R.styleable.Theme_popupWindowStyle /*61*/:
            case C0160R.styleable.Theme_alertDialogCenterButtons /*92*/:
                checkLenient();
                break;
            default:
                return true;
    ...
    private void push(int newTop) {
        if (this.stackSize == this.stack.length) {
            ...
            int[] newPathIndices = new int[(this.stackSize * PEEKED_END_OBJECT)];
            String[] newPathNames = new String[(this.stackSize * PEEKED_END_OBJECT)];
            System.arraycopy(this.stack, PEEKED_NONE, newStack, PEEKED_NONE, this.stackSize);
            System.arraycopy(this.pathIndices, PEEKED_NONE, newPathIndices, PEEKED_NONE, this.stackSize);
            System.arraycopy(this.pathNames, PEEKED_NONE, newPathNames, PEEKED_NONE, this.stackSize);
            this.stack = newStack;
        ...
        while (true) {
            ...
            if (c == PEEKED_UNQUOTED) {
                ...
                switch (buffer[this.pos]) {
                    case C0160R.styleable.Theme_dialogTheme /*42*/:
                        this.pos += PEEKED_BEGIN_OBJECT;
                        if (skipTo("*/")) {
    ...
    public String getPath() {
        ...
        for (int i = PEEKED_NONE; i < size; i += PEEKED_BEGIN_OBJECT) {
            switch (this.stack[i]) {
                case PEEKED_BEGIN_OBJECT /*1*/:
                case PEEKED_END_OBJECT /*2*/:
    ...
    private char readEscapeCharacter() throws IOException {
        if (this.pos != this.limit || fillBuffer(PEEKED_BEGIN_OBJECT)) {
            ...
            switch (escaped) {
                ...
                case C0160R.styleable.Theme_alertDialogCenterButtons /*92*/:
                    break;
                case C0160R.styleable.Theme_autoCompleteTextViewStyle /*98*/:
                    return '\b';
